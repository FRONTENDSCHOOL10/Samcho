...
const MypageSetting = () => {
  return (
    <div className="w-[390px] h-[818px] px-[15px] bg-blue-10 flex-col justify-start items-center gap-10 flex">
        ...
        <section 
          className="w-[319.08px] p-5 bg-white rounded-[10px] shadow flex justify-between items-center"
        ...
        >
          ...
          <DirectionRight className="w-5 h-5 fill-gray-600" />
        </section>

        <button
          className="px-5 py-[15px] bg-red rounded-[10px] shadow flex justify-center items-center"
          aria-label="회원 탈퇴"
        >
